...
/**
 * 3D shape custom data structure
 */
export type Shape3DData = {
  ...
  rotationZ: number;
  /** Depth (Z dimension) of the shape */
  depth: number;
...
/**
 * 3D Cube element - renders as an isometric/perspective cube
 */
export type ExcalidrawCubeElement = _ExcalidrawElementBase & {
  type: "cube";
  customData?: { shape3d?: Shape3DData };
};

/**
 * 3D Rectangular Prism element - renders as an isometric/perspective box
 */
export type ExcalidrawRectangularPrismElement = _ExcalidrawElementBase & {
  type: "rectangularPrism";
  customData?: { shape3d?: Shape3DData };
};

export type Excalidraw3DElement =
  | ExcalidrawCubeElement
  | ExcalidrawRectangularPrismElement;
