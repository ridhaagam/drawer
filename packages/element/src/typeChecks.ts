...
export const isCubeElement = (
  element: ExcalidrawElement | null,
): element is ExcalidrawCubeElement => {
  return element != null && element.type === "cube";
};

export const isRectangularPrismElement = (
  element: ExcalidrawElement | null,
): element is ExcalidrawRectangularPrismElement => {
