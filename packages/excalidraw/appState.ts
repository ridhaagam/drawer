...
>(config: { [K in keyof T]: K extends keyof AppState ? T[K] : never }) =>
  ...
  exportPhysicalWidth: { browser: true, export: false, server: false },
  ...
  presentationFrameIndex: { browser: false, export: false, server: false },
  presentationFrameIds: { browser: false, export: false, server: false },
